...
The APD between the two structures is 38% and the compare.py script generates this image:
![An example output image of the compare.py script.](Figures/7QIG-A_contacts_vs_8EFU-A_contacts.svg)
